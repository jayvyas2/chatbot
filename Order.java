...
public class Order {
	...
	return "Order [orderId=" + orderId + ", orderStatus=" + orderStatus + ", deliveryDate=" + deliveryDate
		+ ", productDetails=" + productDetails + ", refundStatus=" + refundStatus + ", returnStatus="
		+ returnStatus + ", name=" + name + ", feedbackReceived=" + feedbackReceived + "]";
    }
